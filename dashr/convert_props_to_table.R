...
# library("rjson")
#
# js_to_py_type <- function(type_object){
#   js_type_name = (type_object ? is.character(type_object) : type_object[['name']])
#
#   # wrapping everything in lambda to prevent immediate execution
#   js_to_py_types = list(
#     'array' <- function(){return('list')},
#     'bool' <- function(){return('boolean')},
#     'func' <- function(){return('func')},
#     'number' <- function(){return('number')},
#     'string' <- function(){return('string')},
#     'component_name' <- function(){return('component_name')},
#     'object' <- function(){return('dict')},
#
#     'any' <- function(){return('boolean | number | component_name | dict | list')},
#     'element' <- function(){return('dash component')},
#     'node' <- function(){return((
#       'a list of or a singular dash component, component_name or number'
#     ))}
#
#     # # React's PropTypes.oneOf
#     # 'enum': function(){return('one of: {}'.format(', '.join([
...
#   )
#
#   if('computed' %in% type_object & type_object['computed']){
#     return('')
#   }
...
# }
#
# argument_doc <- function(arg_name, type_object, description){
